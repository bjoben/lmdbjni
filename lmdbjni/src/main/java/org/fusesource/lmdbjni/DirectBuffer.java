...
import static org.fusesource.lmdbjni.BitUtil.*;
...
public class DirectBuffer {
  public static final String DISABLE_BOUNDS_CHECKS_PROP_NAME = "jenc.disable.bounds.checks";
  public static final boolean SHOULD_BOUNDS_CHECK = false;//!Boolean.getBoolean(DISABLE_BOUNDS_CHECKS_PROP_NAME);
